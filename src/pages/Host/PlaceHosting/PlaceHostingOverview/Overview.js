      ...
      <div>
        ...
        <div className="container tArticleContainer d-lg-flex">
          <div className="col-md-5">
            <div aria-hidden="true" className="comma">
              “
            </div>
            <h2>
          ...
          <div className="sArticleContainer d-lg-flex">
            ...
            <div className="col-md-6 sArticle">
              <ul>
                ...
                <li className="trueList">House Rules guests must agree to</li>
                <li className="trueList">
                ...
                <li className="trueList">Free $1M liability insurance</li>
                <li className="trueList">24/7 global customer support</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="container host">
          ...
          <div className="sArticleContainer d-lg-flex">
            ...
            <div className="col-md-4 sArticle">
              <h5>Pay low fees</h5>
              <p>
                There’s no cost to sign up. Airbnb generally charges hosts a
                flat 3% per reservation, among the lowest fees in the industry.
              </p>
            </div>
            <div className="col-md-4 sArticle">
        ...
        <div className="container host">
          ...
          <div className="sArticleContainer d-lg-flex">
            <div className="col-md-6 sArticle">
              <h4>What is Airbnb?</h4>
              <p>
                Airbnb connects people with places to stay and things to do
                around the world. The community is powered by hosts, who provide
                their guests with the unique opportunity to travel like a local.
              </p>
            </div>
            <div className="col-md-6 sArticle">
              ...
              <p>
                ...
                earn money by sharing it with anyone in the world. You can host
                your home, activity, or do both. When you host is up to you.
              </p>
        ...
        <div className="container host">
          ...
          <div className="sArticleContainer d-lg-flex">
            <div className="col-md-6 sArticle">
              <a className="articleAnchor" href="#">
          ...
          <div className="sArticleContainer d-lg-flex cards">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">How to start hosting</p>
                <a href="#">Learn more</a>
              </div>
            </div>
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">How Airbnb protects hosts</p>
                <a href="#">Learn more</a>
              </div>
            </div>
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">How you make money on Airbnb</p>
                <a href="#">Learn more</a>
              </div>
            </div>
          </div>
