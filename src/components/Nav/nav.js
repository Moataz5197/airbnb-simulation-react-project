...
import profileIcon from "./media/profile-picture.png"
    ...
    return (
      <>
        <Navbar expand="md" className="navigationBar fixed-top">
          <NavbarBrand href="/placelisting" className="ml-3">
            <Link to="/">
              <svg
                width="110"
                height="50"
                className="d-inline-block mt-3 logo"
                fill="rgb(255, 90, 95)"
              >
          ...
          <NavbarToggler className="testToggle" onClick={toggle} />
          ...
          >
            <Nav className="m-auto">
              <NavItem>
                <div className="border p-2 d-inline-flex rounded-pill searchContainer">
                  <Input
                  ...
                  <Link
                    to={{
                      pathname: "/placelisting",
                      state: { searchQuery },
                    }}
                  >
                    <button
                      type="button"
                      className="btn btn-danger rounded-circle searchBtn"
                    >
            ...
            <Nav className="mr-3">
              <UncontrolledDropdown>
                <DropdownToggle nav>
                  <div className="border p-2 d-inline-flex rounded-pill accountPill">
